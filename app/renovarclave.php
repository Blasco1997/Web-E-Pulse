        ...
        <main class="login">
            <section>
                <form action="<?php echo htmlentities($_SERVER["PHP_SELF"]);?>" method="post">
                    <div class="campo">
                        <?php
                            if(isset($_POST["usuario"]) && isset($_POST["clave"]) && isset($_POST["repetirclave"]) && isset($_POST["acceder"])){
                                renovarClave($_POST["usuario"], $_POST["clave"], $_POST["repetirclave"]);
                            }
                        ?>
                    </div>
                    <div class="campo">
                    ...
                    <div class="campo">
                        <label for="usuario">Vuelva a introducir tu nombre de usuario:</label><br/>
                        <input type="text" name="usuario" required/>
                    </div>
                    <div class="campo">
                        <label for="clave">Introduzca la nueva clave:</label><br/>
                        <input type="password" name="clave" required/>
                    </div>
                    <div class="campo">
                        <label for="repetirclave">Repita la nueva clave:</label><br/>
                        <input type="password" name="repetirclave" required/>
                    </div>
                    <div class="clear"></div>
                    <div class="campo">
                        <button name="acceder">ACTUALIZAR CLAVE</button>
                    </div>
                </form>
            </section>
        </main>
